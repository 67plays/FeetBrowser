...
//!
//! Source data: https://html.spec.whatwg.org/entities.json
...
//!
//! 2231 entries, 2125 of which require the trailing semicolon. The other
//! 106 are the historical semicolon-less forms (`&amp`, `&not`, ...),
