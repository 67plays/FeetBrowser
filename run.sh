...
# without this the fix reaches fresh checkouts and nobody who already hit the
# bug. Re-running venv over an existing directory rewrites pyvenv.cfg and
# leaves everything installed in it exactly where it was.
